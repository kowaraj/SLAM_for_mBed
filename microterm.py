...
class Microterm(object):
    def __init__(self, cbf, port, baudrate, parity, rtscts, xonxoff, echo=False, convert_outgoing=CONVERT_CRLF, repr_mode=0):
        try:
        ...
        self.reader_disabled = False #True
    ...
    def reader(self):
        ...
        try:
            while self.alive and self._reader_alive:
                ...
                # if len(data)>0:
                #     sys.stderr.write("data's ord = " + str(ord(data)) + "\n")
